...
export default function MonteCarloModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div
        className="theme-modal rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl"
      ...
      >
        ...
        {/* Filtro de Sprints */}
        <div className="mb-3">
          <span className="text-[10px] t-muted uppercase font-semibold">Sprints:</span>
        ...
        {/* Filtro de Tipos */}
        <div className="mb-4">
          <span className="text-[10px] t-muted uppercase font-semibold">Tipos:</span>
          <div className="flex flex-wrap gap-1.5 mt-1">
